...
/**
 * Book solution 2 of flexible size stacks.
 * Note that the array is circular.
 * Also note that the solution is far more complex than would be appropriate for an interview.
 */
public class Q1MultiStack {
    ...
    public Q1MultiStack(int numberOfStacks, int defaultSize) {
